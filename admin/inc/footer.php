...
?>
        <!-- Footer -->
        <footer>
            <span id="year-copy"></span> &copy; <strong><a href="https://1.envato.market/7jd"><?php echo $template['name'] . ' ' . $template['version']; ?></a></strong> - Crafted with <i class="fa fa-heart text-danger"></i> by <strong><a href="https://1.envato.market/ydb" target="_blank">pixelcave</a></strong>
        </footer>
        <!-- END Footer -->
    </div>
    <!-- END Inner Container -->
